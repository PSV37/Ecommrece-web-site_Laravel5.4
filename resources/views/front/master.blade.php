...
<header id="header" class="hidden-xs">
    ...
    <div class="container">
    	<div class="row">
			...
			class="logo-container"><img src="{{asset('img/logo.jpg')}}" /></a></div></div>
    		<div class="col-sm-8">
				<div class="nav-link">
					<ul>
                ...
                @foreach(App\Cat::all() as $cat)
				                <li><a href="{{url('products')}}/{{$cat->cat_name}}">{{$cat->cat_name}}</a></li>
				          @endforeach   
				            </ul>
						</li>
		    ...
		    <div class="col-sm-2">
				<div class="nav-btns">
					<div class="nav-cart">
						<img src="{{asset('img/cart.png')}}"/> CART(0)
					</div>
				</div>
		    </div>
		</div>
...
<header id="header" class=" hidden-sm hidden-md hidden-lg">
	...
	<div class="logo"><a href="index.php"><img src="{{asset('img/logo.jpg"')}}" alt=""  /></a></div>
	<div class="m-cart">
		<div class="nav-btns">
			<div class="nav-cart">
...
<script type="text/javascript" src="{{asset('js/html5.js')}}"></script>js/html5.js
